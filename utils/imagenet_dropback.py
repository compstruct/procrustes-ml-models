...
#reduce_plat = ReduceLROnPlateau(monitor='val_loss', 
#                                factor=0.2, 
#                                patience=5,
#                                cooldown=0, 
#                                min_lr=1e-4,
...
def main():
    ...
    if args.drop_back == 'True':
        ...
        optimizer = Dropback(model.parameters(), lr=args.lr, momentum=args.momentum, weight_decay=args.weight_decay, track_size=args.track_weights, q=target_quantile, q_init=args.q_init, q_step=args.q_step, sf=args.q_sf, init_decay=args.init_decay)
    else:
...
# debug parameters for QE
        if args.drop_back == 'True':
            if i % 1000 ==0:
                optimizer.debug_flag=True
            else:
                optimizer.debug_flag=False
